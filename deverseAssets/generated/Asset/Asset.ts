...
export class Asset extends ethereum.SmartContract {
  ...
  uri2(id: BigInt): string {
    let result = super.call("uri2", "uri2(uint256):(string)", [
      ethereum.Value.fromUnsignedBigInt(id)
    ]);
  ...
  try_uri2(id: BigInt): ethereum.CallResult<string> {
    let result = super.tryCall("uri2", "uri2(uint256):(string)", [
      ethereum.Value.fromUnsignedBigInt(id)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  try_basePrefixTokenURI(): ethereum.CallResult<string> {
    let result = super.tryCall(
      "basePrefixTokenURI",
      "basePrefixTokenURI():(string)",
      []
  ...
  _metadataHash(param0: BigInt): Bytes {
    let result = super.call(
      "_metadataHash",
      "_metadataHash(uint256):(bytes32)",
  ...
  try__metadataHash(param0: BigInt): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "_metadataHash",
      "_metadataHash(uint256):(bytes32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  mint(
    ...
    let result = super.call(
      "mint",
      "mint(address,uint40,bytes32,uint256,uint8,address,bytes,uint8):(uint256)",
      [
        ethereum.Value.fromAddress(creator),
        ethereum.Value.fromUnsignedBigInt(packId),
        ...
        ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(xxx))
      ]
    );
  ...
  try_baseSuffixTokenURI(): ethereum.CallResult<string> {
    let result = super.tryCall(
      "baseSuffixTokenURI",
      "baseSuffixTokenURI():(string)",
      []
